...
import ImgProfilePic from "../../../assets/images/img_profile_pic.jpg"
...
const ProfileDetails = () => {
  ...
  return (
    ...
    ">
    <img
      src={imageIsHovered ? ImgProfilePic : ImgProfile}
    ...
    />
      ...
      ">
        ...
        <ButtonGroup className="gap-[8px] shrink-0 w-full justify-start">
          ...
          <Link className="c-icon__link w-[41px]"  href="https://wa.me/639212241135" target = '_blank'>
